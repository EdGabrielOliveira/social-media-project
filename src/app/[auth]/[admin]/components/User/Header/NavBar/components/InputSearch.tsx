...
export default function InputSearch() {
  return (
    <div className="flex flex-1 flex-row  justify-between items-center gap-0 bg-white dark:bg-gray-950 rounded-xl border-gray-300/60 dark:border-gray-800 border shadow-md shadow-gray-200 dark:shadow-gray-950">
      <input
