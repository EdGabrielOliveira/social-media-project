...
export default function UsersMenu({ name, avatar, user, verified }: UsersMenuProps) {
  return (
    <div>
      <ul>
        <a href="#">
          <li className="flex flex-row gap-2 items-center bg-gray-200 dark:bg-gray-950 p-1 rounded-xl w-[16rem] hover:scale-[98%] hover:duration-200">
            <div className="relative flex flex-row items-end">
              <Image
                ...
                height={20}
                width={50}
                className="rounded-full  min-h-[3rem] items-center"
